...
use Phore\ASN\RsaPublicKeyOld;
use PHPUnit\Framework\TestCase;

class RsaPublicKeyTest extends TestCase
{
    public function testCreatePublicKeyFromModExp()
    {
        ...
        $rsaPubKey = new RsaPublicKeyOld();
        $rsaPubKey->createFromModExpBase64($mod, $exp);
    ...
    public function testCreateFromPemPrivateKeyString()
    {
        ...
        $this->assertEquals($mod, $rsaPubKey->getModulusBase64());
        $this->assertEquals($exp, $rsaPubKey->getExponentBase64());
    }
